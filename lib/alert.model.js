...
const {
  ...
  ...rootConsts
} = require(path.join(__dirname, 'alert.model.root.properties'));
const {
  properties: infoProps,
  ...infoConsts
} = require(path.join(__dirname, 'alert.model.info.properties'));
const properties = _.merge({}, rootProps, infoProps);
const constants = _.merge({}, rootConsts, infoConsts);
