...
const AlertSchema = new Schema({
  ...
  source: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Source', order: 1 },
    fake: {
      generator: 'company',
      type: 'companyName'
    }
  ...
  status: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Status', order: 2 },
    fake: true
  },
  ...
  category: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Category', order: 3 },
    fake: true
  },
  ...
  event: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Event', order: 4 },
    fake: {
      generator: 'lorem',
      type: 'sentence'
    }
  ...
  response: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Response', order: 5 },
    fake: true
  },
  ...
  urgency: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Urgency', order: 6 },
    fake: true
  },
  ...
  severity: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Severity', order: 7 },
    fake: true
  },
  ...
  certainty: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Certainty', order: 8 },
    fake: true
  },
  ...
  headline: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Headline', order: 9 },
    fake: {
      generator: 'lorem',
      type: 'sentence'
    }
  ...
  description: {
    ...
    index: true,
    searchable: true,
    exportable: { header: 'Description', order: 10 },
    fake: {
      generator: 'lorem',
      type: 'paragraph'
    }
  ...
  instruction: {
    ...
    index: true,
    searchable: true,
    exportable: { header: 'Instruction', order: 11 },
    fake: {
      generator: 'lorem',
      type: 'paragraph'
    }
  ...
  area: {
    ...
    searchable: true,
    taggable: true,
    exportable: { header: 'Area', order: 12 },
    fake: {
      generator: 'address',
      type: 'county'
    }
  ...
  expectedAt: {
    type: Date,
    index: true,
    exportable: { header: 'Onset', order: 13 },
    fake: {
      generator: 'date',
      type: 'recent'
    }
  ...
  expiredAt: {
    type: Date,
    index: true,
    exportable: { header: 'Expires', order: 14 },
    fake: {
      generator: 'date',
      type: 'future'
    }
...
AlertSchema.methods.afterPost = function afterPost(done) {
  ...
  // TODO use template
  const subject = (alert.headline || alert.event);
  const body = [alert.description, alert.instruction].join('\n');
  const notification = { to: {}, subject: subject, body: body };

  //send notification
  Party.notify(notification, function ( /* error , results*/ ) {
